...
export default Detail;
  ...
  //   console.log("handleNavigateToCart is called.");
  //   if (cartId) {
  //     // Navigate to the cart page with the cartId parameter
  //     console.log("Navigating to:", `/carts/${cartId}`);
  //     navigate(`/carts/${cartId}`);
  //   } else {
  //     console.error("No cartId available. Unable to navigate to the cart page.");
  //   }
  // };
...
// useEffect(() => {
//   const handleAddAndShowSuccess = () => {
//     setAddToCartSuccess(true);
//     console.log(`Added ${quantity} ${prodById.name}(s) to the cart`);
//   };

//   if (addToCartSuccess) {
//     handleAddAndShowSuccess();

//     // Reset addToCartSuccess 
...
//   }
// }, [addToCartSuccess, prodById.name, quantity]);